...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!trimmedFormData.username || !trimmedFormData.email || !trimmedFormData.password) {
    ...
    try {
      ...
      // Navigate to sign-in page if signup is successful
      navigate('/sign-in'); // Ensure that navigate is being called properly
    } catch (error) {
        ...
        <div className="flex-1">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="">
              ...
              <TextInput type="password" placeholder="Password" id="password" onChange={handleChange} autoComplete="off"/>
            </div>
